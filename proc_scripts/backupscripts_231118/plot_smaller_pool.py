...
barwidth=0.3
plt.bar(index-(barwidth*0.5), normalized_IPCs, width=barwidth, label=r'$\frac{1}{5}$'+' capacity', color='#9370db')
plt.bar(index+(barwidth*0.5), smallpool_normalized_IPCs, label=r'$\frac{1}{17}$'+' capacity' , width=barwidth, color='#DDA0DD')
